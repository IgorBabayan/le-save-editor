...
public class CharacterInventory : ICharacterInventory
{
	...
	public ItemDataInfo Weapon => _items!.FirstOrDefault(x => x.Type.IsWeapons())!;
	public ItemDataInfo OffHand => _items!.FirstOrDefault(x => x.Type.IsOffHands())!;
	...
	private async Task<Bitmap> CreateImage(ItemDataInfo itemInfo, IItemInfo<ItemInfoTypeEnum> item)
	{
